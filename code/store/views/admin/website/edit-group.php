...
echo $form->field($model, 'website_id')->dropDownList(\yii\helpers\ArrayHelper::map($website, 'website_id', 'name'), ['disabled' => 'disabled']);
echo $form->field($model, 'name');
echo $form->field($model, 'code');
echo $form->field($model, 'root_category_id')->dropDownList([1 => 'Root']);
echo $form->field($model, 'default_store_id')->dropDownList([]);
